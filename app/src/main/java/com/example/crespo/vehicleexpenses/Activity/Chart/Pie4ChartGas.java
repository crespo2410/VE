...
public class Pie4ChartGas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pie4_chart_gas);
        toolbar = (Toolbar) findViewById(R.id.toolbar);
        toolbar.setBackgroundColor(getResources().getColor(R.color.primary5));
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle(R.string.grafikon_razloga);
        ...
        pieChart = (PieChart) findViewById(R.id.chartPie4Gas);
        ...
        Call<ArrayList<PieGasModel>> getDataRepos = RestClient.getInstance().getApiService().getDataForPie2Gas(parametersModel);
        getDataRepos.enqueue(new Callback<ArrayList<PieGasModel>>() {
            ...
            public void onResponse(Call<ArrayList<PieGasModel>> call, Response<ArrayList<PieGasModel>> response) {
                if (response.isSuccessful()) {
                    ...
                    if (!pieGasModels.isEmpty()) {
                        ...
                        PieDataSet dataSet = new PieDataSet(entries, getString(R.string.naziv_razlog));
            ...
            public void onFailure(Call<ArrayList<PieGasModel>> call, Throwable t) {
                ...
                Toast.makeText(Pie4ChartGas.this, R.string.poruka_greske_dohvata, Toast.LENGTH_SHORT).show();
            }
        });
