...
public class LineChartService extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_line_chart_service);
        ...
        linechart = (LineChart) findViewById(R.id.chartLineService);
        ...
        getDataLineRepos.enqueue(new Callback<ArrayList<PieServisiModel>>() {
            ...
            public void onFailure(Call<ArrayList<PieServisiModel>> call, Throwable t) {
                ...
                Toast.makeText(LineChartService.this, R.string.poruka_greske_dohvata, Toast.LENGTH_SHORT).show();
            }
        });
