...
/**
 * Klasa koja je zadužena za generiranje Linijkog grafikona
 */
public class Line2ChartGas extends AppCompatActivity {


    private String datumOd, datumDo;
    private Toolbar toolbar;
   //stvori se objekt klase LineChart
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //stvaranje objekta za predaju parametara
        ...
        getDataRepos.enqueue(new Callback<ArrayList<LineGasModel>>() {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (!lineGasModels.isEmpty()) {
                        for (int i = 0; i < lineGasModels.size(); i++) {
                            ...
                            entries.add(new Entry(lineGasModels.get(i).getDatum().getTime(), lineGasModels.get(i).getCijena().floatValue()));


                        }


                        //Editiranje (stvaranje, dodavanje podataka, uređivanje) linijskog grafikona
                        ...
                        xAxis.setValueFormatter(new Line2ChartGas.DateValueFormatter());
            ...
            public void onFailure(Call<ArrayList<LineGasModel>> call, Throwable t) {
                ...
                Toast.makeText(Line2ChartGas.this, R.string.poruka_greske_dohvata, Toast.LENGTH_SHORT).show();
