...
public class LineCharOtherExp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_line_char_other_exp);


        toolbar = (Toolbar) findViewById(R.id.toolbar);
        toolbar.setBackgroundColor(getResources().getColor(R.color.primary5));
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle(R.string.grafikon_raspodijele_troskova);
        ...
        linechart = (LineChart) findViewById(R.id.chartLineOther);

        Call<ArrayList<PieOtherModel>> getDataLineRepos = RestClient.getInstance().getApiService().getDataForLineOther(parametersModel);
        getDataLineRepos.enqueue(new Callback<ArrayList<PieOtherModel>>() {
            ...
            public void onFailure(Call<ArrayList<PieOtherModel>> call, Throwable t) {
                ...
                Toast.makeText(LineCharOtherExp.this, R.string.poruka_greske_dohvata, Toast.LENGTH_SHORT).show();
